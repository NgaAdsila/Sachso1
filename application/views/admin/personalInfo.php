    ...
    $(document).ready(function () {
        $('#saveName').click(function () {
            if ($('#staffFullName').val().trim() === "") {
                ...
                $.post(
                    "<?php echo site_url(); ?>admin/Account/editName",
        ...
        $('#saveSex').click(function () {
            $.post(
                "<?php echo site_url(); ?>admin/Account/editSex",
        ...
        $('#saveAdd').click(function () {
            if ($('#staffAdd').val().trim() === "") {
                ...
                $.post(
                    "<?php echo site_url(); ?>admin/Account/editAdd",
                    {addr: $('#staffAdd').val()},
                    function (result) {
                        $('.modal-body').html(result);
                        window.location.reload();
        ...
        $('#saveTel').click(function () {
            if ($('#staffTel').val().trim() === "") {
                ...
                $.post(
                    "<?php echo site_url(); ?>admin/Account/editTel",
                    {tel: $('#staffTel').val()},
                    function (result) {
                        if(result === 'errTel'){
        ...
        $('#saveEmail').click(function () {
            if ($('#staffEmail').val().trim() === "") {
                ...
                $.post(
                    "<?php echo site_url(); ?>admin/Account/editEmail",
        ...
        $('#savePass').click(function () {
            if (($('#staffOldPass').val().trim() === "")||($('#staffNewPass').val().trim() === "")
                ...
                $.post(
                    "<?php echo site_url(); ?>admin/Account/editPass",
